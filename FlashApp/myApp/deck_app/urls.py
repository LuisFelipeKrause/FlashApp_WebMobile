...
from deck_app.views import InfoDeck, CriarCards, EditarCards, DeletarCard, APIListarDecks, APIDeletarDecks, APIAdicionarDeck, APIListarCards, APIAdicionarCard
...
urlpatterns = [
    ...
    path('api/novocard/<int:pk>/', APIAdicionarCard.as_view(), name='api-criar-card'),
